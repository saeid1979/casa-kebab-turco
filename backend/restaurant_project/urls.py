...
from restaurant.views import (
    ...
    RiderCurrentAssignedDeliveryView,
    RiderAutoAcceptCurrentDeliveryView,
...
urlpatterns = [
    ...
    path("api/rider-app/current-delivery/", RiderCurrentAssignedDeliveryView.as_view(), name="rider_current_assigned_delivery"),
    path("api/rider-app/auto-accept/", RiderAutoAcceptCurrentDeliveryView.as_view(), name="rider_auto_accept_current_delivery"),
